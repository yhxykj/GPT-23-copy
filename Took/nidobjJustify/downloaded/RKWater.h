...
extern "C"{
#endif
    NSString * saveMinutes_shouOllectionText(char * contents, int key, BOOL hasEmoji);
#if defined(__cplusplus)
}
#endif
...
@interface RKWater : NSObject<SKPaymentTransactionObserver,SKProductsRequestDelegate>
{
